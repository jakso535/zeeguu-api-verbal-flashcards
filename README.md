...
- set `VERBAL_FLASHCARDS_INVITE_CODES` in `.env` to a comma-separated allowlist of signup or cohort codes such as `Classe2019` or `beta-one,teacherpilot` if you want anyone other than admin/dev users to access verbal flashcards
